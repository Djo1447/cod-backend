...
const BLOCKED_PHONES = [
  ...
  '23968561',  '21623968561',
  '23513132',  '21623513132',
  '98330982',  '21698330982',
  '27330773',  '21627330773',
  '97219788',  '21697219788',
  '94061824',  '21694061824',
  '58561923',  '21658561923',
  '98350552',  '21698350552',
  '28090188',  '21628090188',
  '53532735',  '21653532735',
  '51291111',  '21651291111',
  '26000334',  '21626000334',
];
// ─────────────────────────────────────────────────────────────────────────────
...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      const discountAmount = parseInt(body.discount_amount) || 0;
      ...
      const unitPrice = (price / 100 / parseInt(quantity)).toFixed(3);

      const orderPayload = {
        order: {
          customer: { first_name: firstName || 'Client', last_name: lastName || '.' },
          line_items: [{ variant_id: parseInt(variantId), quantity: parseInt(quantity), price: unitPrice }],
          shipping_lines: [{
